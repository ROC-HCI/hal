## ------------------
## Request model: https://huggingface.co/meta-llama/Llama-3.2-3B-Instruct
## accelerate launch --multi_gpu 7b_DPO-llama-3.2-3B-ddp.py 2>&1 | tee logs/train_llama_3b.log
## Running on 4 H100
## ------------------
...
trained_model_name = "hal16-llama-3.2-3B"
